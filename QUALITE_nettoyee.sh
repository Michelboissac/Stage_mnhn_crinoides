...
DOSSIER_INPUT=/media/mboissac/Expansion/STAGE_MICHEL_CRINOIDES/WORFLOW/NETTOYAGE/   #${repertoire_travail}FASTQ/
DOSSIER_OUTPUT=/media/mboissac/Expansion/STAGE_MICHEL_CRINOIDES/WORFLOW/QUALITE_nettoyee/  #${repertoire_travail}QUALITE_data_non_nettoyee/
liste_nom_base=" "
